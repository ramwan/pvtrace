...
rays_per_light = 50 # recommended to use at least 10000 for statistical accuracy
x_points = 1 # min: 1
y_points = 1 # min: 1
...
z_points = 60
z_start = -extents[2] * 0.09
z_step = (extents[2] * 0.03 - z_start) / z_points
...
custom_lsc.simulate(rays_per_light * num_lights, update_vis=True)
custom_lsc.summary()
