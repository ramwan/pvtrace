...
name = "Hollow Cylinder - Both Sides PV Cell"
...
zscale = trimesh.transformations.scale_matrix(1/8, direction=[0, 0, 1])
xscale = trimesh.transformations.scale_matrix(1/8, direction=[1, 0, 0])
yscale = trimesh.transformations.scale_matrix(1/8, direction=[0, 1, 0])
...
x_start = 0
x_step = 0
y_start = -extents[1]/2 + (extents[1] - extents[1]/2) / y_points
y_step = (extents[1] + y_start) / y_points
